...
public class TodayFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        graphViewModel = ((MainActivity)getActivity()).telemetryViewModel.TodayViewModel;
    ...
    private void sendRequest(ProgressDialog progressDialog, int size, int page) {
        ...
        ANRequest request = telemetriesController.getTodayTelemetry(Math.min(size, 1000), page-1);
